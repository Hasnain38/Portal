...
using Portal.Authentication.TwoFactor.Google;
using Portal.Authorization;
using Portal.Authorization.Accounts;
using Portal.Authorization.Accounts.Dto;
using Portal.Authorization.Delegation;
using Portal.Authorization.Impersonation;
using Portal.Authorization.Users;
using Portal.Configuration;
using Portal.Debugging;
using Portal.Identity;
using Portal.MultiTenancy;
using Portal.Net.Sms;
using Portal.Notifications;
using Portal.Web.Models.Account;
using Portal.Security;
using Portal.Security.Recaptcha;
using Portal.Sessions;
using Portal.Url;
using Portal.Web.Authentication.External;
using Portal.Web.Security.Recaptcha;
using Portal.Web.Session;
using Portal.Web.Views.Shared.Components.TenantChange;
    ...
    public class AccountController : PortalControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(PortalConsts.DateTimeOffsetFormat));
