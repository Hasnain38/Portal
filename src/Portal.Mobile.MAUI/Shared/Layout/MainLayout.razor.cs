...
using Portal.Services.Navigation;
using Microsoft.AspNetCore.Components;
using Portal.Mobile.MAUI.Services.Account;
using Portal.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Portal.Mobile.MAUI.Services.Tenants;
using Portal.Mobile.MAUI.Helpers;

#if ANDROID
using Portal.Mobile.MAUI.Platforms.Android.HttpClient;
#endif
...
#elif IOS
            var abpHttpClientFactory = new Portal.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
