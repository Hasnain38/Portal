...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Portal.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portal.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Portal.OpenIddict.Applications.OpenIddictApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portal.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portal.OpenIddict.Scopes.OpenIddictScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Portal.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Portal.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Portal.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Portal.MultiTenancy.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.HasOne("Portal.MultiTenancy.Payments.SubscriptionPayment", null)
            ...
            modelBuilder.Entity("Portal.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.HasOne("Portal.OpenIddict.Applications.OpenIddictApplication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Portal.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    ...
                    b.HasOne("Portal.OpenIddict.Authorizations.OpenIddictAuthorization", null)
                        .WithMany()
