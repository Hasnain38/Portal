...
using Portal.EntityFrameworkCore.Repositories;

namespace Portal.Organizations
{
    public class UserOrganizationUnitRepository : PortalRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<PortalDbContext> dbContextProvider)
