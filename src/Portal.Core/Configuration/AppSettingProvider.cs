    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        PortalDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        PortalDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            return new Dashboard
            {
                ...
                Pages = new List<Page>
                {
                    new Page($"Page_{PortalDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{PortalDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                ...
                Pages = new List<Page>
                {
                    new Page($"Page_{PortalDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{PortalDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = PortalDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
