...
using Portal.MultiTenancy.Demo;
...
using Portal.MultiTenancy.Subscription;
        ...
        IEventHandler<RecurringPaymentSucceedEventData>
    {
        ...
        public void HandleEvent(RecurringPaymentSucceedEventData eventData)
        {
            _unitOfWorkManager.WithUnitOfWork(() =>
            {
                ...
                if (editionItem == null || !editionItem.Product.Equals(PortalConsts.ProductName))
                {
                    Logger.Warn(
                        $"This is not a payment for {PortalConsts.ProductName} for edition subscription cycle! " +
