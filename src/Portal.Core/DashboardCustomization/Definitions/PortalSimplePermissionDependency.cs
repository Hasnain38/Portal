...
/// </summary>
public class PortalSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public PortalSimplePermissionDependency()
    {
    ...
    public PortalSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public PortalSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
