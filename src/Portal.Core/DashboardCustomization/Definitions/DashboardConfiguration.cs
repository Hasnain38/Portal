...
using Portal.DashboardCustomization.Definitions.Cache;

namespace Portal.DashboardCustomization.Definitions
{
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var simplePermissionDependencyForTenantDashboard =
                new PortalSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);
            ...
            var generalStats = new WidgetDefinition(
                ...
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new PortalSimplePermissionDependency(
                    requiresAll: true,
            ...
            var simplePermissionDependencyForHostDashboard =
                new PortalSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);
